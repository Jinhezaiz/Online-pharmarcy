...
public class MenuControllerTest {
	...
	public void insertMenu() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/menu")
                ...
                .content(JacksonUtil.toJson(menu)))
	...
	public void deleteMenuById() throws Exception {
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.delete("/menu/{id}",
                1L))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print())
				.andReturn();
	...
	public void update() throws Exception {
		...
		//menu.setPerms();
		//menu.setVisible();
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put("/menu")
                .contentType(MediaType.APPLICATION_JSON)
                .content(JacksonUtil.toJson(menu)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print())
	...
	public void selectById() throws Exception {
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/menu/{id}",
                1L))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print())
				.andReturn();
	...
	public void selectPage() throws Exception {
        ...
        map.put("current",2L);
        map.put("size",3L);
        mockMvc.perform(MockMvcRequestBuilders.get("/menu/page")
                .contentType(MediaType.APPLICATION_JSON)
