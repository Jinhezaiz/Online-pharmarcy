...
public class RoleControllerTest {
	...
	public void insertRole() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/role")
                ...
                .content(JacksonUtil.toJson(role)))
	...
	public void deleteRoleById() throws Exception {
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.delete("/role/{id}",
                1L))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print())
				.andReturn();
	...
	public void update() throws Exception {
		...
		//role.setRoleTag();
		//role.setStatus();
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put("/role")
                .contentType(MediaType.APPLICATION_JSON)
                .content(JacksonUtil.toJson(role)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print())
	...
	public void selectById() throws Exception {
		MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/role/{id}",
                1L))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print())
				.andReturn();
	...
	public void selectPage() throws Exception {
        ...
        map.put("current",2L);
        map.put("size",3L);
        mockMvc.perform(MockMvcRequestBuilders.get("/role/page")
                .contentType(MediaType.APPLICATION_JSON)
